...
VS Code settings To open the Settings editor, navigate to File > Preferences > Settings.
...
This inclusive ability is available in Mocha by appending .skip() to the suite or to specific test cases. The skipped tests will be marked as “pending” in the test results. Another quick option is prepending x to the it or the describe: https://danielkorn.io/post/skipping-tests-in-mochajs/
